...
int main(int argc, char** argv) {
    ...
    while(1){
        ...
        // get data w/o checksum (need to alter sizes), remove checksum from data
        // u_short check = cksum(*line2, int filesize/16);
        // compare the two checksums; if not equal do not copy, do not send ack
